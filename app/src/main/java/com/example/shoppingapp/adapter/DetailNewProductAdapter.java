...
public class DetailNewProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<Amazing> data;

    public DetailNewProductAdapter(Context context, List<Amazing> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        //Item Amazing Offer
        if (viewType == 0) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_new_product_detail, parent, false);
            return new AmazingOfferViewHolder(view);
        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.item_first_new_product, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == 0) {
            ...
            ((AmazingOfferViewHolder) holder).setNewProduct(product);
    ...
    public static class AmazingOfferViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setNewProduct(Product product){
            ...
            txt_price.setText(txt_price_deci);
